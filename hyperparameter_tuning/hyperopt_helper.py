...
def tune_lgbm_hyperparameters(model, X, y, model_params, folds=5):
    ...
    return fmin(fn=objective_function, space=space, algo=tpe_algorithm, max_evals=1, trials=None, verbose=1)
